...
# Triangular phase mixing:
#   physical_phase = logical_phase
#   physical_symbol = symbol XOR PHASE_SYMBOL_XOR_MASK when logical_phase is 1
#
# This keeps raw phase reliability at one physical bit, but removes the toxic
# phase-only logical error: a flipped physical phase also decodes as a large
# symbol error. Radius-1 candidate decoding lets the receiver recover likely
# single-bit corruptions without asking for extra packets.
