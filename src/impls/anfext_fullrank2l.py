...
# Different monomial feature map compared to anfext_fullrank2.py
#     > there it is like that always F(0) = 0
#     > a little less efficency for smaller payloads, but less failures for bigger payloads
#     > makes maximal theoretical M to be up to n*(2^(n) - 1)
